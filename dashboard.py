...
feature_description = {
    "class": "🧪 Status Kelayakan Jamur: edible=aman dimakan (e), poisonous=beracun (p)",
...
feature_title = {
    "class": "🧪 Status Kelayakan Jamur: menunjukkan apakah jamur aman dikonsumsi atau beracun berdasarkan karakteristik fisiknya.",
...
if page == "Informasi Dataset":
    ...
    st.markdown("""
    Dataset ini mencakup deskripsi sampel hipotetis yang sesuai dengan 23 spesies jamur berinsang dalam famili Agaricus dan Lepiota yang diambil dari The Audubon Society Field Guide to North American Mushrooms (1981). Setiap spesies diidentifikasi sebagai pasti dapat dimakan, pasti beracun, atau tidak diketahui apakah dapat dimakan atau tidak dan tidak disarankan. Kelas terakhir ini digabungkan dengan kelas yang beracun.           
    """)
